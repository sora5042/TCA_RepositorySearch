...
extension APIClient {
    public func createRequest(method: HTTPMethod, path: String? = nil, parameters: [String: Any]? = nil) -> URLRequest {
...
extension APIClient {
    public func response<Response: Decodable>(method: HTTPMethod, path: String?) async throws -> Response {
